...
import time
import gym_framework.core.train_riskClassifierModel as train_riskClassifierModel
...
request_trigger_transactions_txt = RequestTrigger(new_transactions_produto_node, watch_dir=)
