...
if __name__ == "__main__":
    ...
    save_to_db_node = HandlerNode("SaveToDBHandler",
    ...
    pipeline = PipelineExecutor(
        [],
        [transformador_node, loader_node, classifier_node, save_node, calculete_node, risk_classifier_node, save_to_db_node]
    )
